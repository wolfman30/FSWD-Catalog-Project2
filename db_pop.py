...
detail1 = HallmarkDetails(name = 'Endogenous threats', description = 'Reactive Oxygen', treatment = 'None', references = 'Bitchin ass sources!')
session.add(detail1)
session.commit()

detail2 = HallmarkDetails(name = 'Exogenous threats', description = 'Chemicals, Radiation: Ultraviolet & Infrared', treatment = 'None', references = 'Bitchin ass sources!')
session.add(detail2)
session.commit()
...
telomere_attrition = AgingHallmark(name="Telomere attrition", 
                    summary = '''From normal cell divsion the gradual 
                                 reduction of the compound nucleotide structures on the ends of chromosomes that 
...
summary = '''Cellular senescence occurs when cells stop dividing as they should. 
...
summary = '''The inability of stem cells to replenish tissues and organs with functional specialized cells
...
summary = '''Signaling between cells, over time, will increase in self-preserving signals, 
